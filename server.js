...
<style>.session-timeout-options{display:flex;flex-direction:column;gap:6px;margin-top:6px}.session-timeout-option{display:flex;align-items:center;gap:7px;font-size:50%;line-height:1.2;cursor:pointer}.session-timeout-option input{appearance:none;-webkit-appearance:none;width:13px;height:13px;border:1px solid currentColor;border-radius:2px;display:inline-grid;place-content:center;margin:0;flex:0 0 auto}.session-timeout-option input:checked::after{content:"✓";font-size:11px;font-weight:700;line-height:1}.session-timeout-option input:focus-visible{outline:2px solid currentColor;outline-offset:2px}
